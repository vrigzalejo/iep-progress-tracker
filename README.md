...
```bash
docker build -t iep-progress-tracker:0.4.1 .
# Kind: kind load docker-image iep-progress-tracker:0.4.1
# Minikube: minikube image load iep-progress-tracker:0.4.1
