...
export function SignInForm() {
  ...
  const [error, setError] = useState(params.get("error") ? "Sign-in was not successful. Check your email and password." : "");
    ...
    <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
      <Card>
        ...
        <p className="mt-4 text-sm text-muted">
          After eight failed attempts, sign-in is paused for 15 minutes. Read the{" "}
