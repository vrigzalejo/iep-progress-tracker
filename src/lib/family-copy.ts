...
const COPY = {
  en: {
    ...
    send: "Send",
    familyHomeNav: "Family home",
    messagesNav: "Messages",
    privacyNav: "Privacy",
    guideNav: "Setup guide",
    signOut: "Sign out",
    headerLinked: "Family portal — linked students only",
    openMenu: "Open menu",
    closeMenu: "Close menu",
    parentRole: "Parent / guardian",
    skipToContent: "Skip to main content",
    noMessages: "No messages yet. Keep notes short and about this child only.",
    messageSent: "Message sent",
    messageSentBody: "The team can read it on the family thread. Staff-only notes never appear here.",
    language: "Language",
    english: "English",
    spanish: "Español",
    reportHeader: "report",
  ...
  es: {
    ...
    send: "Enviar",
    familyHomeNav: "Inicio familiar",
    messagesNav: "Mensajes",
    privacyNav: "Privacidad",
    guideNav: "Guía",
    signOut: "Cerrar sesión",
    headerLinked: "Portal familiar — solo estudiantes vinculados",
    openMenu: "Abrir menú",
    closeMenu: "Cerrar menú",
    parentRole: "Padre / tutor",
    skipToContent: "Saltar al contenido principal",
    noMessages: "Todavía no hay mensajes. Escriba notas cortas y solo sobre este niño.",
    messageSent: "Mensaje enviado",
    messageSentBody: "El equipo puede leerlo en el hilo familiar. Las notas solo para el personal no aparecen aquí.",
    language: "Idioma",
    english: "English",
    spanish: "Español",
